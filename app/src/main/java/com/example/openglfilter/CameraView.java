...
//        opengl  有讲究
    ...
    public void saveScreenPic(Boolean save){
        renderer.readPixels(save);
    }
    public void openBeauty(boolean beauty){
        renderer.openBeauty(beauty);
    }
    public void openFilter(boolean filter){
        renderer.openFilter(filter);
    }   public void openEffect(boolean effect){
        renderer.openEffect(effect);
    } public void openEffect2(boolean effect){
        renderer.openEffect2(effect);
    }
}
